  ...
  return (
    <div className="App">
      <header>
        ...
        <nav>
          <Link to="/">HOME</Link>
          <Link to="/destinations">POPULAR <br/>DESTINATIONS</Link>
          <Link to="/travelpackage">TRAVEL<br/> PACKAGES</Link>
          <Link to="/events">POPULAR <br/>EVENTS</Link>
          <Link to="/contact">CONTACT <br/>US</Link>
        </nav>
      </header>
